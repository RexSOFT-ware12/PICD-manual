...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  const settingsItems = [
    ...
    // Temporarily disabled for React #310 isolation; restore after the crash is isolated.
